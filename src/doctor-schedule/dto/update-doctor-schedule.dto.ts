...
export class UpdateDoctorScheduleDto {
  ...
  @ApiPropertyOptional({ enum: DayOfWeek, isArray: true, description: 'Days of week', example: ['MONDAY', 'TUESDAY'] })
  @IsOptional()
  @IsArray()
  @ArrayMinSize(1)
  ...
  @ApiPropertyOptional({ type: [TimeSlotDto], description: 'Time slots' })
  @IsOptional()
  @IsArray()
  @ArrayMinSize(1)
